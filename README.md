...
💡 **Leadership through Collaboration:** I thrive on guiding teams and blending diverse perspectives to drive innovation. My approach is simple: motivate, involve, and turn every challenge into a shared victory.
🎯 **Vision:** Building scalable, intelligence-driven solutions that bridge the gap between low-level architecture and high-level AI.
🧠 **Current Focus:** Deep-diving into **Deep Learning** and mastering **Data Structures & Algorithms (DSA)** to build a solid problem-solving foundation.
...
![Data Structures](https://img.shields.io/badge/-DSA-FFD700?style=for-the-badge&logo=data-structures&logoColor=black)
...
* **Deep Learning Specialization** – *DeepLearning.AI (by Andrew Ng) on Coursera*
  * *Currently mastering Neural Networks, CNNs, and Sequence Models.*
* **Classical Machine Learning** – *Completed foundational concepts and implementation.*

---

## 🚀 Key Projects

* **AI-Powered Assistive Glasses:** A wearable solution for the visually impaired using Deep Learning for real-time text and currency recognition.
* **Moon & Mars Resort Platform:** A comprehensive web application featuring event booking and a personalized user dashboard.
